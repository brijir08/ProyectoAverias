package com.brijir.averias.helpers;
...
public class PreferencesManager {
    ...
    private static final String NAME_FILE = "app.preferences";
    ...
    public static void savePreferences(Context ctx, String username, String password, boolean remember){
        if(mPreferences == null){
            mPreferences = ctx.getSharedPreferences(NAME_FILE, ctx.MODE_PRIVATE);
        }
